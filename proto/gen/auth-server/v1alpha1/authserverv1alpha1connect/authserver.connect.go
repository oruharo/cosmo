...
package authserverv1alpha1connect

import (
	context "context"
	errors "errors"
	connect_go "github.com/bufbuild/connect-go"
	v1alpha1 "github.com/cosmo-workspace/cosmo/proto/gen/auth-server/v1alpha1"
...
const (
	...
	AuthServiceName = "authserver.v1alpha1.AuthService"
)
...
const (
	...
	AuthServiceLoginProcedure = "/authserver.v1alpha1.AuthService/Login"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/authserver.v1alpha1.AuthService/Logout"
	// AuthServiceVerifyProcedure is the fully-qualified name of the AuthService's Verify RPC.
	AuthServiceVerifyProcedure = "/authserver.v1alpha1.AuthService/Verify"
)

// AuthServiceClient is a client for the authserver.v1alpha1.AuthService service.
...
// NewAuthServiceClient constructs a client for the authserver.v1alpha1.AuthService service. By
...
// Login calls authserver.v1alpha1.AuthService.Login.
...
// Logout calls authserver.v1alpha1.AuthService.Logout.
...
// Verify calls authserver.v1alpha1.AuthService.Verify.
...
// AuthServiceHandler is an implementation of the authserver.v1alpha1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/authserver.v1alpha1.AuthService/", mux
}
...
func (UnimplementedAuthServiceHandler) Login(context.Context, *connect_go.Request[v1alpha1.LoginRequest]) (*connect_go.Response[v1alpha1.LoginResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("authserver.v1alpha1.AuthService.Login is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("authserver.v1alpha1.AuthService.Logout is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) Verify(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[v1alpha1.VerifyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("authserver.v1alpha1.AuthService.Verify is not implemented"))
}
